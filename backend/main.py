...
from modules.auth import getCurrentActiveUser, getCurrentUser, User, getCurrentUserNoAuthForTest
...
def extend_link_endpoint(uuid: str, extension: int, current_user: Annotated[User, Depends(getCurrentUserNoAuthForTest)]):  # TODO: Change to getCurrentActiveUser after testing
